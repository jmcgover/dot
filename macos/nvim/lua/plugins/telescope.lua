return {
    {
        ...
        version = '*',
        enabled = false,  -- When false, or if the function returns false, then this plugin will not be included in the spec
        dependencies = {  -- list of plugin names or plugin specs that should be loaded when the plugin loads
            ...
            { --  C port of fzf only covering the algorithm and implements
